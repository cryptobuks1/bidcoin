...
* bidgold.conf: contains configuration settings for bidgoldd or bidgold-qt
* bidgoldd.pid: stores the process id of bidgoldd while running
...
* debug.log: contains debug information and general logging generated by bidgoldd or bidgold-qt
