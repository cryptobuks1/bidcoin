...
"""Verify that starting bidgold with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bidgold with -h for help text")
        ...
        self.log.info("Start bidgold with -version for version information")
