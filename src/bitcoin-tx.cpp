...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bidgold-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bidgold-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bidgold transaction") + "\n" +
              "  bidgold-tx [options] -create [commands]   " + _("Create hex-encoded bidgold transaction") + "\n" +
              "\n";
