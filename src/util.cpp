...
const char * const BITCOIN_CONF_FILENAME = "bidgold.conf";
const char * const BITCOIN_PID_FILENAME = "bidgoldd.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Bidcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Bidcoin";
#else
    // Unix
    return pathRet / ".bidgold";
#endif
#endif
}
